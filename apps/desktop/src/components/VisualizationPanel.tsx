...
const MAX_TOPOLOGY_BOTS = 40;
const TOPOLOGY_VIEWBOX_WIDTH = 360;
const TOPOLOGY_VIEWBOX_HEIGHT = 260;
const TOPOLOGY_CENTER_X = TOPOLOGY_VIEWBOX_WIDTH / 2;
const TOPOLOGY_CENTER_Y = TOPOLOGY_VIEWBOX_HEIGHT / 2;
const TOPOLOGY_RING_RADII = [56, 92, 126, 158];
const TOPOLOGY_RING_CAPACITY = [8, 10, 12, 10];
